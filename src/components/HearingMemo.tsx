                ...
                <div className="w-80 bg-white/95 backdrop-blur-xl border-l border-slate-200 flex flex-col overflow-hidden">
                    ...
                    <div className="px-4 py-3 border-b border-slate-100 bg-slate-50/30 flex gap-2">
                        ...
                        >
                            ...
                            <span className="text-[9px] font-black text-slate-600 tracking-tight uppercase">Support Panel</span>
                        </button>

                        <button
                            onClick={openPiPSupport}
                            className="flex items-center justify-center w-10 h-10 bg-slate-900 text-white rounded-xl hover:bg-slate-800 transition-all group/support shadow-xl shadow-slate-200"
